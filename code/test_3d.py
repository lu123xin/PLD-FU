...
parser.add_argument('--root_path', type=str, default='/root/autodl-tmp/mutual-learning-with-reliable-pseudo-labels/', help='Name of Experiment')
...
snapshot_path = "/mnt/workspace/mutual-learning-with-reliable-pseudo-labels/data/{}_{}_{}_labeled/{}".format(
    FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, FLAGS.model)
test_save_path = "/mnt/workspace/mutual-learning-with-reliable-pseudo-labels/data/{}_{}_{}_labeled/{}_predictions/".format(
    FLAGS.dataset_name, FLAGS.exp, FLAGS.labelnum, FLAGS.model)
